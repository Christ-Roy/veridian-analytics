# Analytics — TODO dette technique & infrastructure

> ⚠️ **Pour le sprint actif et la roadmap features, va dans :**
> - [`../../INDEX.md`](../../INDEX.md) — navigation générale agent
> - [`../../SPRINT.md`](../../SPRINT.md) — sprint vivant en 2-3 sessions
> - [`../../UI-POLISH.md`](../../UI-POLISH.md) — backlog polish UI hot-reload
>
> Ce fichier ne contient QUE la dette technique long terme + l'infrastructure.
...
👉 Voir [`../../SPRINT.md`](../../SPRINT.md) pour le sprint actif et [`../../INDEX.md`](../../INDEX.md) pour la liste exhaustive des tickets.

Ce qui suit dans ce fichier = **dette + infra uniquement**.
